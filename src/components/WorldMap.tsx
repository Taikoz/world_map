    ...
    <div className="w-full h-screen">
      <div className="grid grid-cols-3 gap-2 w-full h-full">
        <div className="col-span-1 bg-gray-900 text-white p-4 overflow-auto">
          <div
            className={`absolute top-8 left-8 z-10 transition-all duration-1000 ${
              isLoaded
          ...
          <div
            className={`absolute bottom-8 left-8 z-10 transition-all duration-1000 ${
          ...
          <CityInformation
            className="fixed top-40 left-20 z-50"
            city={hoveredCity}
          />
        </div>
